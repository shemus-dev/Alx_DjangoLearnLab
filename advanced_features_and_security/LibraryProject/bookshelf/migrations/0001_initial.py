    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_type', models.CharField(choices=[('basic', 'Basic'), ('premium', 'Premium'), ('admin', 'Admin')], default='basic', max_length=20)),
            ...
            options={
                'permissions': [('can_access_premium', 'Can access premium features'), ('can_manage_content', 'Can manage all content')],
            },
        ),
        migrations.CreateModel(
            name='Book',
